...
function SingleProduct({ match, fetchSingleProduct, item }, history) {
    ...
    const ProductArea=()=>{
        const { productId, productName, productPrice, productContent, thumbnail, productCategory, productSize, artistName } = item;
                ...
                <div className="product_image_area">
                    <div className="container" >
                        <div className="row s_product_inner">
                            <div className="col-lg-6">
                                <div className="owl-theme s_Product_carousel">
                            ...
                            <div className="col-lg-5 offset-lg-1">
                                <div className="s_product_text">
                                    ...
                                    <p>{artistName}</p>
                                    <ul className="list">
                                        <li><a className="active" href="#"><span>Category</span> : {category_name}</a></li>
...
const mapDispatchToProps = (dispatch) => ({
    fetchSingleProduct: (id) => dispatch(Actions.fetchSingleProduct(id))
})
