...
<p/>
<br/>제1조(목적)
<br/>이 약관은 ARTFACTORY(이하 “회사”라 한다)가 운영하는 아트팩토리 웹사이트와 (이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다.
<br/>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
<p/>
<br/>제2조(정의)
<br/>① “몰”이란 ARTFACTORY가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
<br/>① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호,모사전송번호,전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수 있도록 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
<br/>  6. 결제방법의 선택
<br/>② “몰”이 제3자에게 구매자 개인정보를 제공•위탁할 필요가 있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때 “몰”은 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유•이용 기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.
<br/>③ 판매를 목적으로 게시한 작품에 대하여 “회사”는 판매권을 가집니다. 작품에 대한 소유권은 작가에게 있으며, 판매가 발생하여 작품이 구매자에게 전달되고 작가수익 정산이 완료되면 소유권은 구매자에게 양도됩니다.
<p/>
<br/>제10조 (계약의 성립)
...
<p/>
<br/>제14조(환급)
<br/>“몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.
<p/>
<br/>제15조(청약철회 등)
...
<br/>⑨ “몰”은 개인정보의 수집•이용•제공에 관한 동의란을 미리 선택한 것으로 설정해두지 않습니다. 또한 개인정보의 수집•이용•제공에 관한 이용자의 동의거절시 제한되는 서비스를 구체적으로 명시하고, 필수수집항목이 아닌 개인정보의 수집•이용•제공에 관한 이용자의 동의 거절을 이유로 회원가입 등 서비스 제공을 제한하거나 거절하지 않습니다.
<p/>
<br/>제18조(“몰“의 의무)
...
<p/>
<br/>제22조(게시물의 관리)
<br/>“회사”는 다음 각 호에 해당하는 게시물이나 콘텐츠를 사전 통지 없이 삭제하거나 이동 또는 등록을 거부할 수 있습니다.
<br/>- 다른 회원 또는 제 3자에게 심한 모욕을 주거나 중상모략으로 명예를 손상시키는 내용인 경우 
<br/>- 청소년보호법에 위반되는 내용의 정보, 문장, 도형 등을 게시거나 링크 시키는 경우 
<br/>- 청소년보호법에 위반되는 음란한 내용이거나 음란사이트를 링크 시키는 경우 
<br/>- 회원 ID 또는 사이버 자산등의 매매에 관련된 내용인 경우 
<br/>- 불법복제 또는 해킹을 조장하는 내용인 경우 
<br/>- 영리를 목적으로 하는 광고일 경우 
<br/>- 범죄와 결부된다고 객관적으로 인정되는 내용일 경우 
<br/>- 다른 회원 또는 제 3자의 저작권 등 기타 권리를 침해하는 내용인 경우 
<br/>- “회사”에서 규정한 게시물 원칙에 어긋나거나, 게시판 성격에 부합하지 않는 경우 
<br/>- 기타 관계 법령에 위배된다고 판단되는 경우
<p/>
<br/>제23조(저작권의 귀속 및 이용제한)
<br/>① “몰”이 작성한 저작물에 대한 저작권 기타 지적재산권은 “몰”에 귀속합니다.
<br/>② 회원이 서비스 화면 내에 게시한 게시물의 저작권은 게시한 회원에게 귀속됩니다. 또한 “회사”는 게시자의 동의 없이 게시물을 상업적으로 이용할 수 없습니다. 다만 비영리 목적인 경우는 그러 하지 아니하며, “회사”의 마케팅 및 홍보자료에 유저가 게시한 컨텐츠의 일부 또는 썸네일 이미지 등이 사용될 수 있습니다. 
...
<br/>⑤ “회사”는 회원이 게시하거나 등록하는 서비스 내의 내용물, 게시 내용에 대해 제22조 각 호에 해당된다고 판단되는 경우 사전통지 없이 삭제하거나 이동 또는 등록 거부할 수 있습니다.
<p/>
<br/>제24조(유지 보수 및 지원)
<br/>① TODAYART 재화에 대한 유지 보수 또는 지원을 제공하지만, 이러한 유지 보수 또는 지원을 제공할 법적 의무를 가지지는 않습니다.
<p/>
<br/>제25조(분쟁해결)
...
<p/>
<br/>제27조(정보의 제공 및 광고의 게재)
<br/>① “회사”는 “회원”이 “몰” 이용 중 필요하다고 인정되는 다양한 정보를 공지사항 또는 전자우편이나 서신우편, SMS, 전화, 모바일메신저 등의 방법으로 회원에게 제공할 수 있습니다. 다만, 회원은 관련법에 따른 거래관련정보 및 고객문의 등에 대한 답변 등을 제외하고는 언제든지 전화우편 등에 대해서 수신 거절을 할 수 있습니다.
<br/>② “회사”는 “몰”의 운영과 관련하여 서비스 화면, 홈페이지, 전자우편이나 서신우편, SMS, 전화, 모바일메신저 등에 광고를 게재할 수 있습니다. 광고가 게재된 전자우편 등을 수신한 회원은 수신거절의 의사표시를 할 수 있으며, 회사는 수신거절을 위한 방법을 회원에게 제공합니다.
<br/>③ 다만, “회사”는 “몰”이용에 필수적으로 요구되는 정보(예: 관련 규정/정책의 변경 등)에 대해서는 “회원”의 수신거부의사와 무관하게 이를 제공 할 수 있습니다.
<br/>④ “회원”의 가입과 동시에 제25조 1,2항의 “회사”의 정보 제공에 대해 수신동의 한 것으로 간주합니다.
<p/>
<br/>부칙(시행일)
<br/>이상의 약관은 2019년 9월 5일부터 시행합니다.
</div>)
}